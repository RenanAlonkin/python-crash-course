...
for user in user_fav_langs.keys():
    if(user in user_answers):
        ...
        print("Hey {}, you haven't answered our pool yet, don't forget about it huh!".format(user.title()))
...
for key, value in favorite_numbers.items():
    print("{} favorite numbers are: {}".format(key.capitalize(), ", ".join(map(str, value))))
